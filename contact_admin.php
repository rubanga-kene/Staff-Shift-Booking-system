...
<body>
    <div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
      ...
      <div>
        ...
        <div class="item">
          <ul class="nostyle zero " style="line-height: 2;">
            <a href="dashboard.php"><li ><i class="fa fa-circle-o fa-fw"></i>Shift</li></a>
      ...
      <div class="item">
          <ul class="nostyle zero" style="line-height: 2;">
           <a href=""><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Contact</li></a>
    ...
    <!-- ARTICLE -->
      <div class="content2"> 
        <div>
          <span style="font-size: 16pt;color: #333333">Contact </span>
          <p>Our Contacts</p>
